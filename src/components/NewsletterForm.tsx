    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-3">
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <button
          ...
          className="px-6 py-3 bg-accent text-white rounded-xl font-medium hover:bg-accent-dark transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
        >
          {status === "loading" && (
      ...
      {status === "already" && (
        <p className="text-yellow-400 text-sm">You&apos;re already subscribed!</p>
      )}
      {status === "error" && (
